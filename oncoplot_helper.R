mutation_colors <- c(Nonsense_Mutation="#ad7aff",Missense_Mutation="#377EB8",Frame_Shift_Del="#4DAF4A",
                     ...
                     Splice_Region="red",Silent="blue",
                     Germline_Missense_Mutation="#377EB8",
                     Germline_Frame_Shift_Del="#4DAF4A", Germline_Frameshift_Del="#4DAF4A",Germline_Frameshift_Deletion="#4DAF4A", 
                     Germline_Nonsense_Mutation="#ad7aff",
                     #no_variants="white", 
                     Pathogenic="black",COSMIC="grey25",VUS="grey50")
...
#                     Amplification="red",Deletion="blue",
                     #no_variants="white", 
#                     Splice_Region="red",Silent="blue",
#                     Germline_Missense_Mutation="#377EB8",Germline_Frame_Shift_Del="#4DAF4A", Germline_Frameshift_Del="#4DAF4A", Germline_Frameshift_Deletion="#4DAF4A", 
#                     Germline_Nonsense_Mutation="#ad7aff",
#                     Pathogenic="black",VUS="grey50")
...
createoncomat=function(maf,genes,CLINVAR=F,COSMIC=F){
